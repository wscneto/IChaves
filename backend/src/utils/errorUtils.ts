...
export class ValidationUtils {
    ...
    static validateRequired(value: unknown, fieldName: string, req?: Request): void {
        if (value === undefined || value === null || value === '') {
            ErrorUtils.throwValidationError(`${fieldName} is required`, { field: fieldName, value }, req)
        }
    }
    ...
    static async validateUserExists(IDUserFK: string) {
        ...
        if (!user) {
            ErrorUtils.throwValidationError('User not found')
        }
    }
...
/**
 * Authentication helpers (optional - for when authentication is implemented)
 */
export class AuthUtils {
    ...
    /**
     * Check if user owns resource (optional)
     */
    ...
    /**
     * Check if user is authenticated (optional - returns boolean)
     */
     ...
     */
    static getUserRole(req: AuthenticatedRequest): 'admin' | 'student' | null | undefined {
