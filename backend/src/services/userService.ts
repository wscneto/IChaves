...
import { UserCreationData } from '../types/auth'
...
export class UserService {
    ...
    static async createUser(userData: CreateUserData) {
        try {
            ...
            if (existingUser) {
                throw new AppError(ErrorCode.RESOURCE_CONFLICT, 'User with this email already exists', 409)
            }
            ...
            throw new AppError(ErrorCode.DATABASE_ERROR, 'Failed to create user', 500)
        }
    }
    ...
    static async getUserById(id: string) {
        try {
            ...
            throw new AppError(ErrorCode.DATABASE_ERROR, 'Failed to fetch user', 500)
        }
    }
    ...
    static async getAllUsers() {
        try {
            ...
            throw new AppError(ErrorCode.DATABASE_ERROR, 'Failed to fetch users', 500)
        }
    }
    ...
    static async updateUser(id: string, userData: UpdateUserData) {
        try {
            ...
            throw new AppError(ErrorCode.DATABASE_ERROR, 'Failed to update user', 500)
        }
    }
    ...
    static async deleteUser(id: string) {
        try {
            ...
            throw new AppError(ErrorCode.DATABASE_ERROR, 'Failed to delete user', 500)
        }
    }
    ...
    static async findOrCreateUserByEmail(data: UserCreationData): Promise<FullPrismaUser> {
        try {
            ...
            throw new AppError(ErrorCode.DATABASE_ERROR, 'Falha ao encontrar ou criar usuário', 500)
        }
    }
}
